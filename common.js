...
/*
	Devuelve un array con los grupos que hay en la selección.
*/
function filterGroups(selection){
	var len = selection.length()
	var groups = []
	for(var i=0; i<len; ++i){
		if(isGroup(selection[i])){
...
/*
	Elimina de la selección todo lo que no sea una capa de texto.
*/
function filterSelectionWithTextLayers() {
...
/*
	Elimina de la selección todo lo que no sea una capa vectorial.
*/
function filterSelectionWithShapeLayers() {
	var sel = context.selection;
	var selLen = sel.length();
	var i;
	var layer;
